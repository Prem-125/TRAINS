...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_10 = QLabel(self.LineBox)
        self.label_10.setObjectName(u"label_10")
        self.label_10.setGeometry(QRect(410, 50, 271, 71))
        self.scrollArea = QScrollArea(self.LineBox)
        self.scrollArea.setObjectName(u"scrollArea")
        self.scrollArea.setGeometry(QRect(660, 20, 371, 121))
        self.scrollArea.setWidgetResizable(True)
        self.scrollAreaWidgetContents = QWidget()
        self.scrollAreaWidgetContents.setObjectName(u"scrollAreaWidgetContents")
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 369, 119))
        self.occupied_block_list = QLabel(self.scrollAreaWidgetContents)
        self.occupied_block_list.setObjectName(u"occupied_block_list")
        self.occupied_block_list.setGeometry(QRect(20, 10, 55, 16))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_10.setText(QCoreApplication.translate("Dialog", u"<html><head/><body><p><span style=\" font-size:12pt;\">Current Occupied Blocks:</span></p></body></html>", None))
        self.occupied_block_list.setText(QCoreApplication.translate("Dialog", u"<html><head/><body><p>temp</p></body></html>", None))
