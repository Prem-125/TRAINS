...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_13.setGeometry(QRect(10, 20, 261, 311))
        ...
        self.trackStatusBox.setGeometry(QRect(10, 300, 351, 141))
        ...
        self.trackSignalBox.setGeometry(QRect(10, 470, 351, 51))
        ...
        self.selTrackStation.setGeometry(QRect(254, 250, 91, 31))
        ...
        self.upTrackBlue = QRadioButton(self.tab_2)
        self.upTrackBlue.setObjectName(u"upTrackBlue")
        self.upTrackBlue.setGeometry(QRect(20, 130, 95, 20))
        self.upTrackBlue.setChecked(True)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.LineBox.setTitle(QCoreApplication.translate("Dialog", u"Blue Line", None))
        ...
        self.label_3.setText(QCoreApplication.translate("Dialog", u"<html><head/><body><p><span style=\" font-size:10pt;\">\u2022 Speed Limit:</span></p><p><span style=\" font-size:10pt;\">\u2022 Authroity:</span></p><p><span style=\" font-size:10pt;\">\u2022 Beacon:</span></p><p><span style=\" font-size:10pt;\"><br/></span></p></body></html>", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), QCoreApplication.translate("Dialog", u"Blue Line", None))
        ...
        self.upTrackBlue.setText(QCoreApplication.translate("Dialog", u"Blue Line", None))
